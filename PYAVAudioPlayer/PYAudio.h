 ...
 */
typedef enum{
    PYAVAudioPlayerStatusPrepare,
    PYAVAudioPlayerStatusPlay,
    PYAVAudioPlayerStatusPause,
    PYAVAudioPlayerStatusStop
} PYAVAudioPlayerStatus;
...
@property (nonatomic, readonly) PYAVAudioPlayerStatus playerStatus;
/**
 添加音频播放文件URL
 */
